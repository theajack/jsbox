                ...
                <div class='jsbox-tool-w'>
                    <dropdown>
                        ...
                        <dropdown-menu slot="dropdown">
                            <dropdown-item icon="el-icon-plus">黄金糕</dropdown-item>
                            <dropdown-item icon="el-icon-circle-plus">狮子头</dropdown-item>
                            <dropdown-item icon="el-icon-circle-plus-outline">螺蛳粉</dropdown-item>
                            <dropdown-item icon="el-icon-check">双皮奶</dropdown-item>
                            <dropdown-item icon="el-icon-circle-check">蚵仔煎</dropdown-item>
                        </dropdown-menu>
                    </dropdown>
                    <i class="ei-github" title='github' @event='goGithub'></i>
                    <i class="ei-play" title='运行代码(ctrl + enter)' @event='run'></i>
